using FleetKnowledge.Domain.Events;
using Microsoft.Extensions.Logging;

namespace FleetKnowledge.Application.TodoItems.EventHandlers;
...
public class LogTodoItemCompleted : INotificationHandler<TodoItemCompletedEvent>
{
    ...
    {
        _logger.LogInformation("FleetKnowledge Domain Event: {DomainEvent}", notification.GetType().Name);
